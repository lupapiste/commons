(ns lupapiste-commons.building-classifications)

(def rakennuksen-rakennusluokka
  [{:name "0110 omakotitalot"}
   ...
   {:name "0912 elintarviketeollisuuden tuotantorakennukset"}
   ...
   {:name "1010 sähköenergian tuotantorakennukset"}
   {:name "1011 lämpö- ja kylmäenergian tuotantorakennukset"}
